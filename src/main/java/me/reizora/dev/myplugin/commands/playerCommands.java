        ...
        if (sender instanceof Player player){
            ...
            if (command.getName().equalsIgnoreCase("fly")) { // enable or disable flight on creative mode.
                if (player.hasPermission("admin")) {
                    ...
                    player.sendMessage(ChatColor.RED+ "You have no permission to execute that command!");
                }
            }
            ...
            Bukkit.broadcastMessage("This command can only be executed by a player entity.");
        }
        return true;
    }
